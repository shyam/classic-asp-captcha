...
// Can be converted to a Palleted Png (256 color) later!
...
// Draw 5 Random Lines - With Random Color!
for (var i = 0; i < 5; i++)
	gdImage.Line(Math.random() * 200, Math.random() * 200, Math.random() * 200, Math.random() * 200, gdImage.Color(Math.random() * 255, Math.random() * 255, Math.random() * 255));
